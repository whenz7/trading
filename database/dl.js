...
const exchange_limit = JSON.parse(fs.readFileSync('database/config/exchange_limit.json', 'utf8'));
const tf_ms = JSON.parse(fs.readFileSync('database/config/tf_ms.json', 'utf8'));
const coin_list = JSON.parse(fs.readFileSync('database/config/coin_list.json', 'utf8'));
...
// --- Edit exchange here ---
let exchange = new ccxt.bybit({ enableRateLimit: true })
pair_list = ["BTCUSDT"]
timeframe_list = ["1m"]
